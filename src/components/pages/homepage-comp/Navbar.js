    ...
    <nav className="bg-olive-dark h-16 flex items-center px-5 sm:px-10 fixed top-0 w-full z-10 shadow-xl">
      ...
      <div className="hidden md:flex items-center text-center ml-auto justify-between gap-x-4">
        <button
          ...
          className="font-semibold text-beige px-4 py-2 rounded hover:bg-grayish duration-300"
        >
          Homes
        </button>
        <button
      ...
      {menuOpen && (
        <div
          className={`absolute top-16 left-0 w-full bg-olive-dark flex flex-col items-center gap-y-3 py-5 shadow-md md:hidden z-50 transition-all duration-500 ease-in-out`}
        >
          <button
            onClick={() => handleNavigateToSection("homes-section")}
            className="text-beige font-semibold px-4 py-2 hover:bg-grayish hover:text-beige rounded w-11/12 transition"
          >
            Homes
          </button>
          <button
