...
const HostMessages = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row bg-gradient-to-br from-white to-gray-50 rounded-3xl shadow-2xl h-[85vh] md:h-[75vh] overflow-hidden border border-white/60">
      ...
      >
        <div className="p-4 md:p-6 border-b border-gray-200/50 bg-gradient-to-r from-olive-dark/5 to-olive-dark/10">
                ...
                >
                  {conversation.guestPic ? (
                    <img
                      ...
                      className="w-10 h-10 md:w-12 md:h-12 rounded-full mr-3 object-cover ring-2 ring-white shadow-sm"
                    />
                  ) : (
      ...
      {/* 💬 Chat Panel */}
      <div
        className={`relative w-full md:w-2/3 flex flex-col bg-white transition-all duration-300 ${
      ...
      >
        {selectedConversation ? (
          <>
            {/* Header */}
            <div className="flex items-center justify-between border-b border-gray-200/50 p-4 md:p-6 bg-gradient-to-r from-white to-gray-50/50 backdrop-blur-sm">
              <div className="flex items-center gap-3 md:gap-4">
                {/* 🔙 Mobile back button */}
                <button
                  className="md:hidden p-2 -ml-2 text-gray-600 hover:text-olive-dark"
                ...
                {selectedConversation.guestPic ? (
                  <img
                    ...
                    className="w-10 h-10 md:w-12 md:h-12 rounded-full object-cover ring-2 ring-olive-dark/20 shadow-md"
                  />
                ) : (
              ...
              {messages.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full gap-4 text-center">
                  <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-gradient-to-br from-olive-dark/10 to-olive-dark/5 flex items-center justify-center">
                    <svg
                      className="w-8 h-8 md:w-10 md:h-10 text-olive-dark/50"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <p className="text-sm text-gray-400 mt-1">
                    Send a message to {selectedConversation.guestName}
                  </p>
                </div>
              ) : (
                    ...
                    >
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div
                            className={`text-[10px] md:text-xs mt-1 text-gray-400 font-medium ${
            ...
            {/* Input Box */}
            {/* 💬 Fixed Input Bar - stays at the very bottom */}
            <div className="border-t border-gray-200/50 p-4 md:p-6">
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
            <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-gradient-to-br from-olive-dark/10 to-olive-dark/5 flex items-center justify-center mb-6">
              <svg
                className="w-10 h-10 md:w-12 md:h-12 text-olive-dark/50"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
